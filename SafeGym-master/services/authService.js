...
import { trainerManager, userManager } from '@/services/resourceManager';
import { useAuthStore } from '@/stores/useAuthStore';
  ...
  export async function LoginWithEmail(email, password) {
    try {
      ...
      const trainerData = await trainerManager.get(User.uid);
      if(trainerData){
        useAuthStore.getState().setUser(trainerData, trainerData.role);
        console.log(useAuthStore.getState().role);
        return trainerData;
      }
      ...
      if(User){
        ...
        useAuthStore.getState().setUser(userDoc, userDoc.role);
        console.log(useAuthStore.getState().role);
        return userDoc;
      }else{
